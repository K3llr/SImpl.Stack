...
public class QueryHandlerInstrumentationDecorator<TQuery, TResult> : IQueryHandler<TQuery, TResult> where TQuery : class, IQuery<TResult>
{
    private readonly IQueryHandler<TQuery, TResult> _base;

    public QueryHandlerInstrumentationDecorator(IQueryHandler<TQuery, TResult> @base)
    {
        _base = @base;
    }
    ...
    public async Task<TResult> HandleAsync(TQuery query)
    {
        ...
        return await _base.HandleAsync(query);
    }
}