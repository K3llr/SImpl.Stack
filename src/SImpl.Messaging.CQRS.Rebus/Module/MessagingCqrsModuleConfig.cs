...
namespace SImpl.Messaging.CQRS.Rebus.Module
{
    ...
    {
        public MessagingCqrsModuleConfig(Func<RebusConfigurer, RebusConfigurer> configureRebusService = null)
        {
            ConfigureRebusService = configureRebusService;
        }

        public Func<RebusConfigurer, RebusConfigurer> ConfigureRebusService { get; set; }
